...
//        $valid->add_rules('description', 'required', 'mb_length[1,255]');
        ...
        $valid->add_rules('origin_link', 'length[0,255]');
        $valid->add_rules('source', 'required', 'mb_length[1,20]');
//        $valid->add_rules('status', 'required', 'in[0,1]');
        $valid->add_rules('tag', 'required', 'mb_length[0,255]');
        $valid->add_rules('display_type', 'required', 'in[1,2,3,4,5]');
        $valid->add_rules('video_uri', 'length[0,255]');
